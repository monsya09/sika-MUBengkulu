...
<div class="container-fluid ">
    <div class="row">
        <div class="col-12 text-center"><strong>Rincian Nilai Mahasiswa </strong></div>
    </div>
</div> 
        ...
        <table id="example" class="display pl-3" style="width:100%">
            <tbody>
                <tr style="font-size: 10 ; line-height: 1em;" class="p-0">
                    <td>Matakuliah</td>
                    <td>: {{ $getDetail->kelaskuliah->matakuliah->namaMataKuliah }}</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                ...
                <tr style="font-size: 10 ; line-height: 1em;" class="p-0">
                    <td>Program Studi</td>
                    <td>: {{ $getDetail->kelaskuliah->programstudi->programStudi }}</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                ...
                <tr style="font-size: 10 ; line-height: 1em;" class="p-0">
                    <td>T.A.</td>
                    <td>: {{ $getDetail->kelaskuliah->tahunAkademik->idTahunAkademik }}</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                ...
                <tr style="font-size: 10 ; line-height: 1em;" class="p-0">
                    ...
                    <td>: {{ $getDetail->kelaskuliah->matakuliah->semester }}/{{ $getDetail->kelaskuliah->masterkelas->kelas }}</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <table class="table table-sm" style="margin-left:10 ; font-size: 10 ;">
            <thead>
                <tr>
                    ...
                    <th>Nama</th>
                    <th>NPM</th>
                    <th>Tugas <div class="text-xs">{{ isset($getDetail)?$getDetail->bobotTugas:'' }}%</div></th>
                    <th>UTS <div class="text-xs">{{ isset($getDetail)?$getDetail->bobotUTS:'' }}%</div></th>
                    <th>UAS <div class="text-xs">{{ isset($getDetail)?$getDetail->bobotUAS:'' }}%</div></th>
                    <th>Nilai Angka</th>
                    <th>Nilai Huruf</th>
                </tr>
            </thead>
